...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .form-container h4 { color:#fff; font-weight:800; margin-bottom:20px; font-size:16px; }
        ...
        .btn-actualizar { background:#FF6B00; color:#fff; padding:12px 30px; border:none; border-radius:10px; font-weight:800; width:100%; cursor:pointer; font-size:15px; transition:.2s; }
